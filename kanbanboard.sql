...
INSERT INTO `post` (`PID`, `Title`, `Content`, `DateCreated`, `DateModified`, `DateDue`, `UID`, `LID`, `CID`) VALUES
(1, 'Change Template Color in KyNepal Android App', 'Change Template Color in KyNepal Android App', '2016-10-16 00:00:00', '2016-10-16 15:21:13', '2016-10-30 00:00:00', 1, 5, 1),
(2, 'Create Kanban Board login page', 'Create an login page for kanban board. When user visit the website, first take them to this login page. Once they login successfully, redirect them to the dashboard.', '2016-10-16 12:23:21', '2016-10-16 21:21:24', '2016-10-26 23:59:59', 1, 2, 2),
(3, 'Just Testing out Kanban Baord', 'THis is just a test content from kanban board. This content area should be very detailed.', '2016-10-13 00:00:00', '2016-10-15 00:00:00', '2016-10-16 00:00:00', 1, 4, 1),
(4, 'CECS 310 - HW 10 Chapter 20', 'Homework for CECS 310 - Chapter 20. Following are the problems to do.', '2016-10-17 00:00:00', '2016-10-17 00:00:00', '2016-10-23 00:00:00', 1, 1, 1);
...
(1, 'Manorath', 'Dhakal', 'mahendra', 'dhakal');
